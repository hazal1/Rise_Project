    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 2, 13, 2, 53, 2, 531, DateTimeKind.Local).AddTicks(5166), "Kıvırcıklar Ülkesi", "Hazal", "Çelik", null },
                    { 2, new DateTime(2022, 2, 13, 2, 53, 2, 531, DateTimeKind.Local).AddTicks(5180), "Karanfil", "Sinem", "Durak", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "PersonContacts",
                columns: new[] { "Id", "CityId", "Email", "PersonId", "Phone" },
                values: new object[] { 2, 5, "Sinem@hotmail.com", 2, "05512695659" });
